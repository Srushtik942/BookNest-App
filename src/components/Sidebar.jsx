...
// Updated Sidebar component with responsive improvements
import React, { useState } from 'react';
import { toast, ToastContainer } from 'react-toastify';
...
const handleCategoryChange = async (event) => {
  ...
  return (
<div className="p-4 w-full sm:w-60 md:w-66 bg-white shadow-md rounded-xl border border-gray-200 h-fit max-h-screen overflow-y-auto">
