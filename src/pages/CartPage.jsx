...
const CartPage = () => {
  ...
  return (
    <div className="py-8 min-h-screen">
      ...
      <div className="mx-auto max-w-6xl p-4 flex flex-row lg:flex-row gap-6">
          ...
          <div className="flex flex-col justify-between flex-1">
            ...
            <div className="mt-4 pt-4 border-t border-gray-200">
                ...
                <div className="flex items-center mb-6">
                    <span className="text-black font-semibold mr-4">Quantity:</span>
                    <div className="flex items-center border border-black rounded">
                        ...
                        <span className="px-4 text-black border-l border-r border-black">{quantity}</span>
                        <button
                ...
                <div className="flex gap-4">
                    <button className="flex-1 bg-gray-600 text-white py-2 rounded font-semibold hover:bg-gray-700 transition">
                        REMOVE
                    </button>
                    <button className="flex-1 bg-gray-200 text-gray-800 py-2 rounded font-semibold hover:bg-gray-300 transition">
                        MOVE TO WISHLIST
                    </button>
                </div>
            </div>
        ...
        <div className="lg:w-96 flex-shrink-0 bg-white p-6 rounded-lg shadow-md h-fit">
          ...
          <button className="w-full bg-blue-600 text-white py-3 rounded font-semibold hover:bg-blue-700 transition duration-150">
            PLACE ORDER
          </button>
        </div>
      </div>
